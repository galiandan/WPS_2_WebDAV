...
SOURCE_REF="${WPS_ADAPTER_SOURCE_REF:-8fa439f5135a3ec7c4f9b47cffc3d28ccf97a1c0}"
...
BINARY_RELEASE_TAG="${WPS_ADAPTER_BINARY_RELEASE_TAG:-v0.9.100}"
...
环境变量：
  ...
  WPS_ADAPTER_BINARY_RELEASE_TAG       预编译二进制 Release 标签，默认 v0.9.100
