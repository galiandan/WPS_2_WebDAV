...
SOURCE_REF="${WPS_ADAPTER_SOURCE_REF:-8e2e10488294459319884dc417054426d0083e57}"
SOURCE_MANIFEST_SHA256="${WPS_ADAPTER_SOURCE_MANIFEST_SHA256:-fbeaf77d0bf15ef584615740298127985e65601854663b56c214875c2711767e}"
