...
SOURCE_REF="${WPS_ADAPTER_SOURCE_REF:-f13d1558c67b8612488dc092eb34791b6dc3ebff}"
SOURCE_MANIFEST_SHA256="${WPS_ADAPTER_SOURCE_MANIFEST_SHA256:-0d4c3bd216a30751512264b6a2f1e3bf4d4faf6a871711de0f149a864d359dfe}"
