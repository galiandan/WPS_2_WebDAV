...
SOURCE_REF="${WPS_ADAPTER_SOURCE_REF:-b32609d9b62862f09775b108a6e18720e64d8a7c}"
SOURCE_MANIFEST_SHA256="${WPS_ADAPTER_SOURCE_MANIFEST_SHA256:-a274abdd338bd4f1537453c523f7097469681a3cf2e600f5c8cb241528ef49e5}"
