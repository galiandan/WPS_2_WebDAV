...
SOURCE_REF="${WPS_ADAPTER_SOURCE_REF:-d3bcf4c674de83ea37e39114e4b810343e39df98}"
...
BINARY_RELEASE_TAG="${WPS_ADAPTER_BINARY_RELEASE_TAG:-v1.0.8}"
...
环境变量：
  ...
  WPS_ADAPTER_BINARY_RELEASE_TAG       预编译二进制 Release 标签，默认 v1.0.8
