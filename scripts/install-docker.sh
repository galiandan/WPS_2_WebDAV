...
SOURCE_REF="${WPS_ADAPTER_SOURCE_REF:-a92653f73928e37573207cf265854b95609c9505}"
BINARY_RELEASE_TAG="${WPS_ADAPTER_BINARY_RELEASE_TAG:-v0.9.94}"
...
环境变量：
  ...
  WPS_ADAPTER_BINARY_RELEASE_TAG       预编译二进制 Release 标签，默认 v0.9.94
